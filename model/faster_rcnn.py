...
class RegionProposalNetwork(nn.Module):
    ...
    def assign_targets_to_anchors(self, anchors, gt_boxes):
        ...
        # This copy of best_match_gt_idx will be needed later to add to the low quality matches
        ...
        # Update the matched gt index for all these anchors with whatever was the best gt box prior to the thresholding
        best_match_gt_idx[pred_inds_to_update] = best_match_gt_idx_pre_thresholding[pred_inds_to_update]

        # Here clamp the background and ignore boxes to zero
...
class ROIHead(nn.Module):
    ...
    def assign_target_to_proposals(self, proposals, gt_boxes, gt_labels):
        ...
        # Clamp the bg and ignore boxes to zero
...
class FasterRCNN(nn.Module):
    ...
    def normalize_resize_image_and_boxes(self, image, bboxes):
        ...
        # but larger dimension is not more than 1000, So compute scale factor for both and scale is minimum of these two
        h, w = image.shape[-2:]
